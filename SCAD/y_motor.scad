...
{
  union() {
    translate([0,(60+5)/2,(5+z_shift)/2])roundcube([40,60+5,5+z_shift],center=true);
    translate([0,40+4/2,(20+5+z_shift)/2])cube([40,4,20+5+z_shift],center=true);
  }
  translate([0,20,0])#linear_extrude(height=10)stepper_motor_mount(17);
  translate([0,40/2,5/2+5])#cube([40,40,5],center=true);
